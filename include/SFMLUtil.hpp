...
void draw_grid (sf::RenderTexture& background, const std::vector<Vec2D>& control_points)
{
  ...
  for (int i = 0; i < control_points.size(); i++)
    draw_point (background, VEC_TO_CANVAS (control_points.at (i)), R_PX * 2, c1);
}
 ...
 */
void draw_control_lines (sf::RenderTexture& foreground, const Bezier& bezier, float t, float step)
{
